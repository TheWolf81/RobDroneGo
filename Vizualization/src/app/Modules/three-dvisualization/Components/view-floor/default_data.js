...
export const mazeData = {
    url: "./../../assets/mazes/4756a87f-167c-44d0-8dd3-cd7b799c4229.json",
    c: " deHellod by Cecília Fernandes and Nikita.",
    scale: new THREE.Vector3(1.0, 1.0, 1.0)
}

export const playerData = {
    url: "../../../assets/models/gltf/Robot/robot1.glb",
    credits: "Wheeled Robot (https://skfb.ly/ouCQD) by Andrei Milin is licensed under _Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).",
